import SwiftUI
  ...
  & 0xF) * 17)
          ...
          case 8: // ARGB (32-bit)
              (a, r, g, b) = (int >> 24, int >> 16 & 0xFF, int >> 8 & 0xFF, int
  & 0xFF)
          default:
              (a, r, g, b) = (255, 0, 0, 0)
          }
      ...
      static let accentCustom = Color(hex: "#FFD23F")
      static let success = Color(hex: "#06D6A0")
      static let textDark = Color(hex: "#1A1A1A")
      static let textLight = Color(hex: "#6B6B6B")
      static let backgroundMain = Color(hex: "#FAFAFA")
      static let backgroundCard = Color(hex: "#FFFFFF")
      static let borderColor = Color(hex: "#E8E8E8")
  }
